...
static ctl_handler handlers[] = {
        timeout_common, /* OP_TIMEOUT */
        timeout_common, /* DURABILITY_TIMEOUT */
        timeout_common, /* DURABILITY_INTERVAL */
        timeout_common, /* VIEW_TIMEOUT */
        bufsize_common, /* RBUFSIZE */
        bufsize_common, /* WBUFSIZE */
        get_htype, /* HANDLETYPE */
        get_vbconfig, /* VBCONFIG */
        get_iops, /* IOPS */
        get_kvb, /* VBMAP */
        conninfo, /* MEMDNODE_INFO */
        conninfo, /* CONFIGNODE_INFO */
        syncmode, /* SYNCMODE */
        ippolicy, /* IP6POLICY */
        confthresh, /* CONFERRTHRESH */
};
...
{
    lcb_cntl(LCB_CNTL_SET, instance, LCB_CNTL_SYNCMODE, &val);
}
...
{
    lcb_syncmode_t ret;
    lcb_cntl(LCB_CNTL_GET, instance, LCB_CNTL_SYNCMODE, &ret);
    return ret;
}
...
{
    lcb_ipv6_t ret;
    lcb_cntl(LCB_CNTL_GET, instance, LCB_CNTL_IP6POLICY, &ret);
    return ret;
}
...
{
    lcb_size_t ret;
    lcb_cntl(LCB_CNTL_GET, instance, LCB_CNTL_CONFERRTHRESH, &ret);
    return ret;
}
...
{
    lcb_cntl(LCB_CNTL_SET, instance, LCB_CNTL_OP_TIMEOUT, &usec);
}
...
{
    lcb_uint32_t ret;
    lcb_cntl(LCB_CNTL_GET, instance, LCB_CNTL_OP_TIMEOUT, &ret);
    return ret;
}
...
{
    lcb_cntl(LCB_CNTL_SET, instance, LCB_CNTL_VIEW_TIMEOUT, &usec);
}
...
{
    lcb_uint32_t ret;
    lcb_cntl(LCB_CNTL_GET, instance, LCB_CNTL_VIEW_TIMEOUT, &ret);
    return ret;
}
